...
function bsm_enqueue_assets( $hook ): void {
    ...
    if ( 'health' === $bsm_tab ) {
        wp_enqueue_style( 'bsm-health', ASY_PLUGIN_URL . 'assets/health.css', [], BSM_VERSION );
        wp_enqueue_script( 'bsm-health', ASY_PLUGIN_URL . 'assets/health.js', [], BSM_VERSION, true );
        wp_localize_script( 'bsm-health', 'BSM_HEALTH', [
            'ajax_url'   => admin_url( 'admin-ajax.php' ),
...
function bsm_render_page(): void {
    ...
    if ( $tab === 'health' ) { BSM_Health::render(); return; }
